...
{'power': False, 'mode': 'normal', 'speed': 35, 'roll_enable': False, 'roll_angle': 140, 'time_off': 0, 'light': True, 'beep_sound': False, 'child_lock': False}
*/
...
module.exports = class MiFan extends Fan
  ...
  enableAngle(targetState) {
    if (targetState == 'on' || targetState == 'off') {
      targetState = targetState == 'on' ? true : false;
    }
		return this.call('s_roll', [ targetState ], { refresh: [ 'roll' ] })
			.then(() => null);
	}

	changeAngle(targetAngle) {
